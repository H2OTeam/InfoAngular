...
export class PostComponent implements OnInit {
 ...
 public createAlias() {
  ...
  public search() {
    this._dataService.get('Posts/' + this.pageIndex + '/' + this.pageSize + '?filter=' + this.filterKeyword)
  ...
  private loadPostCategories() {
    this._dataService.get('postCategorys/GetParent').subscribe((response: any[]) => {
  ...
  public showEdit(id: string) {
    this._dataService.get('posts/' + id).subscribe((response: any) => {
    ...
    this.notificationService.printConfirmationDialog(MessageContstants.CONFIRM_DELETE_MSG, () => {
      this._dataService.deleteBase('posts/'+ id).subscribe((response: any) => {
  ...
  public deleteMulti() {
    ...
    this.notificationService.printConfirmationDialog(MessageContstants.CONFIRM_DELETE_MSG, () => {
      this._dataService.delete('posts/deletemulti', 'checkedProducts', JSON.stringify(checkedIds)).subscribe((response: any) => {
        this.notificationService.printSuccessMessage(MessageContstants.DELETED_OK_MSG);
        this.search();
      }, error => this._dataService.handleError(error));
    });
