...
export class PostCategoryComponent implements OnInit {
  ...
  //Load data
  public search() {
    this._dataService.get('postCategorys?filter =' + this.filter)
  ...
  public getListForDropdown() {
    this._dataService.get('postCategorys/GetParent')
      .subscribe((response: any[]) => {
        this._Categories = response;
      }, error => this._dataService.handleError(error));
  }
  ...
  public deleteConfirm(id: string): void {
    this._dataService.deleteBase('postCategorys/'+ id).subscribe((response: any) => {
  ...
  public saveData(valid: boolean) {
    if (valid) {
      if (this.editFlg == false) {
        this._dataService.post('postCategorys', this.entity).subscribe((response: any) => {
          this.search();
        ...
        this._dataService.put('postCategorys/'+this.entity.id, this.entity).subscribe((response: any) => {
          this.search();
          this.addEditModal.hide();
